...
const Right = ({ navbar, setNavbar, currentPage }) => {
  ...
  return (
    <div className="flex right    sm:py-10  flex-col h-screen text-white items-center justify-between fixed">
      ...
      <h2 className="right-h2 uppercase">{currentPage}</h2>
      <div className="flex flex-col gap-2 cursor-pointer socials">
        <a
          target="_blank"
        ...
        <a target="_blank" href="https://github.com/jaybhuptani10">
          {" "}
          <svg
            viewBox="0 0 1024 1024"
            fill="currentColor"
