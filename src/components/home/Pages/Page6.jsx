...
const Page6 = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center text-white z-20">
      <div className="bg-black h-[70vh] sm:h-[70vh] w-[90vw] sm:w-[70vw] flex flex-col rounded-xl overflow-hidden sm:flex-row z-20 shadow-lg">
        <div className="w-full h-[50%] sm:h-full sm:w-1/2 p-6 sm:p-8">
          <h1 className="text-2xl sm:text-3xl font-bold mt-2 sm:mt-6 mb-10">
            ...
            <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className="inline-block ml-2 w-6 h-6 text-red-600"
            >
              <path
                strokeLinecap="round"
        ...
        <div className="w-full h-[50%] sm:w-1/2 sm:h-full relative overflow-hidden">
          <motion.img
